 ...
 *
 * The tag loads UNCONDITIONALLY so Google can detect it,
 * but analytics_storage and ad_storage default to 'denied'.
 * When the user accepts cookies, consent is updated to 'granted'.
 *
 * Place in root layout — NOT behind ConsentAwareAnalytics.
 */
