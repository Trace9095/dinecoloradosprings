    ...
    (
      <div
        style={{
          ...
          height: '100%',
          display: 'flex',
          background: 'linear-gradient(160deg, #0A1208 0%, #0D1117 55%, #0D1117 100%)',
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              The Colorado<br />Springs Dining Blog
            </div>

            <div style={{ fontSize: 21, color: '#9E9080', lineHeight: 1.5, maxWidth: 580 }}>
              Guides, day trips, hidden gems &amp; local food stories from the Rockies
            </div>
          </div>
