  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Right circular plate decoration */}
        <div
          style={{
            position: 'absolute',
            right: -80,
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              Colorado&apos;s Best<br />Dining Guide
            </div>
            ...
            >
              Discover restaurants, breweries, cafes &amp; food trucks in Colorado Springs — in the shadow of Pikes Peak.
            </div>
          </div>
