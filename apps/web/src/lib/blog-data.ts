...
export const SEED_BLOG_POSTS: SeedBlogPost[] = [
  {
    id: 1,
    title: "Best Restaurants in Colorado Springs 2026: A Local's Complete Guide",
    slug: 'best-restaurants-colorado-springs-2026',
    excerpt:
    ...
    content: `# Best Restaurants in Colorado Springs 2026: A Local's Complete Guide
...
**Nearby:** Canon City, just 1 hour south via CO-115, has its own excellent dining scene including White Water Bar & Grill (whitewaterbar.com) on Hwy 50 West, and Rooftop Social (wwrooftopsocial.com) with panoramic rooftop views.`,
  ...
  {
    id: 2,
    title: 'Colorado Springs Craft Brewery Guide: Every Brewery Worth Visiting',
    slug: 'craft-breweries-colorado-springs-guide',
    excerpt:
    ...
    content: `# Colorado Springs Craft Brewery Guide: Every Brewery Worth Visiting
...
**Seek out limited releases.** Trinity's barrel-aged releases, Bristol's seasonal specialties, and Cerberus's experimental batches are worth watching the calendar for.`,
  ...
  {
    id: 3,
    title: 'Best Outdoor Patios in Colorado Springs for Dining and Drinks',
    slug: 'best-patios-colorado-springs',
    excerpt:
    ...
    content: `# Best Outdoor Patios in Colorado Springs for Dining and Drinks
...
**Sunsets:** Many downtown patios face west, meaning spectacular Pikes Peak-framed sunsets. Plan accordingly.`,
  ...
  {
    id: 4,
    title: 'Happy Hour Guide: Best Drink and Food Deals in Colorado Springs',
    slug: 'happy-hour-guide-colorado-springs',
    excerpt:
      "Colorado Springs has some outstanding happy hours — from downtown craft brewery specials to pub deals and half-price appetizers. Here's every happy hour worth knowing about.",
    content: `# Happy Hour Guide: Best Drink and Food Deals in Colorado Springs

Colorado Springs has a thriving after-work happy hour culture, driven in large part by a robust craft brewery and bar scene centered downtown. Whether you're looking for discounted pints after work, half-price appetizers before a night out, or a reliably great deal on cocktails, the options are excellent.

This guide covers the best happy hours in Colorado Springs, organized by what you're looking for.

## Best Craft Beer Happy Hours

### Phantom Canyon Brewing Co

Phantom Canyon runs one of the most generous and consistent happy hours in Colorado Springs. **Monday through Friday, 3–6 PM**: $1 off all draft beers (already reasonably priced), discounted appetizers, and access to the rooftop bar or street patio depending on the season. At a brewery with 12+ house beers on tap at all times, this is exceptional value.

Best order: The rotating seasonal IPA or the flagship Zebulon Pale Ale, plus the brewery's loaded pretzel or flatbread appetizer.

**Hours:** Mon–Fri 3:00–6:00 PM

### Bristol Brewing Company

Bristol doesn't run traditional happy hour pricing, but their everyday prices are so competitive that it deserves mention alongside dedicated happy hour destinations. At the Ivywild School taproom, pints of award-winning beer start around $6, and the patio beer garden is one of the most pleasant places to be in Colorado Springs on a weekday afternoon.

### Cerberus Brewing Company

Cerberus runs midweek happy hours with rotating specials on selected draft beers and appetizers. Their Trivia Night (Thursday evenings) pairs naturally with the discounted drink period — arrive early, grab a table, and settle in.

## Best Bar Happy Hours

### Jack Quinn Irish Pub

Jack Quinn's has one of the longest-running and most-loved happy hours in Colorado Springs. **Monday through Friday, 4–7 PM**: $1 off draft beers, discounted well spirits, and reduced prices on classic Irish pub appetizers (loaded potato skins, wings, chips and dip). The welcoming atmosphere and 20 beers on draft make the three-hour window feel like a gift.

Best order: A pint of Guinness and a plate of fish and chips, or the shepherd's pie if you're hungry.
...
Shuga's social hours offer cocktail specials and discounted small plates. Given the restaurant's creative kitchen and charming patio, this is an ideal warm-weather happy hour destination.

**Hours:** Tue–Fri 3:00–5:00 PM

## Happy Hour Tips

**Timing:** Colorado Springs happy hours typically run weekdays between 3–7 PM. Weekend happy hours are rare; Friday evenings are the busiest.

**Downtown concentration:** The highest concentration of happy hour options is in the downtown Tejon Street/Pikes Peak Avenue corridor. Park once and walk between venues.

**Food is key:** The best happy hours in Colorado Springs pair drink specials with meaningful food deals. Jack Quinn's and Phantom Canyon both offer solid food discounts alongside drink specials.

**Rooftop bonus:** Phantom Canyon's rooftop bar access during happy hour adds a dimension most cities can't match. Arrive by 4 PM to secure outdoor seating on warm evenings.`,
    imageUrl: null,
    published: true,
  },
  {
    id: 5,
    title: 'Fine Dining in Colorado Springs: From The Broadmoor to Local Gems',
    slug: 'fine-dining-colorado-springs-broadmoor',
    excerpt:
    ...
    content: `# Fine Dining in Colorado Springs: From The Broadmoor to Local Gems
