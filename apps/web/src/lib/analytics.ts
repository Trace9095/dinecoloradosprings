...
//   listing_view            — business listing detail page viewed
//   listing_click_phone     — phone number clicked on listing
//   listing_click_website   — website link clicked on listing
//   listing_click_directions — directions/maps link clicked
//   listing_claim           — "Claim this listing" form started
//   listing_purchase        — paid listing subscription completed
//   category_search         — category filter applied
//   search_query            — search bar query submitted
//   cta_click               — call-to-action button clicked
//   form_submit             — any form successfully submitted
//   phone_call              — phone number clicked (any context)
//   external_link           — outbound link clicked
